pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Chat"], nil, function()
      ...
      CreateConfig(nil, T["Show Native Chat Buttons"], C.chat.global, "nativebuttons", "checkbox")
    ...
    CreateGUIEntry(T["Thirdparty"], T["Integrations"], function()
      ...
      CreateConfig(nil, "UnitXP SP3 (" .. T["Skin"] .. ")", C.thirdparty.unitxpsp3, "skin", "checkbox", nil, nil, nil, nil, "vanilla")
